							...
							<form target="_blank"
							 method="get">
								<div class="input-group">
									<input type="text" class="form-control" name="EMAIL" placeholder="Search Iteams" onfocus="this.placeholder = ''"
									 onblur="this.placeholder = 'Search Items '" required="" type="email">
