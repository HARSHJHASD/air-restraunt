						...
						<div class="collapse navbar-collapse menu-right" id="collapsibleNavbar">
							<ul class="navbar-nav justify-content-center w-100">
								...
								<li class="nav-item dropdown">
									...
									<div class="dropdown-menu">
										<a class="dropdown-item" href="blog-home.php">Blog</a>
										<a class="dropdown-item" href="blog-single.php">Blog Detail</a>
									</div>
								</li>
								<li class="nav-item">
					...
					<div class="single-post row">
						...
						<div class="col-lg-3  col-md-3 meta-details">
							...
							<div class="user-details row">
								<p class="user-name col-lg-12 col-md-12 col-6"><a href="#">Yousif</a> <span class="lnr lnr-user"></span></p>
								<p class="date col-lg-12 col-md-12 col-6"><a href="#">17 March,2021</a> <span class="lnr lnr-calendar-full"></span></p>
								<p class="view col-lg-12 col-md-12 col-6"><a href="#">1.k Views</a> <span class="lnr lnr-eye"></span></p>
						...
						<div class="col-lg-9 col-md-9">
							...
							<p>
								...
								money on boot
								camp when you can get the MCSE study materials yourself at a fraction of the camp price. However, who has the
								willpower
								to actually sit through a self-imposed MCSE training. who has the willpower to actually sit through a
								self-imposed
							</p>
							<p>
								Boot camps have its supporters and its detractors. Some people do not understand why you should have to spend
	...
	<footer class="footer-area section-gap">
		<div class="container">
			...
			<div class="footer-bottom row align-items-center">
				<p class="footer-text m-0 col-lg-6 col-md-12">Copyright © 2018 All rights reserved to <a href="#">Colorlib</a></p>
